...
class App:
    def __init__(self):
        ...
        self.alimentos = {alimento['nome'] : Alimento(alimento['nome'], alimento['porcao'], alimento['calorias'], alimento['proteina'], alimento['carboidrato'], alimento['gordura']) for alimento in self.db.carregar_dados('alimentos').values()}
